...
function onCountdownTick(counter)
	...
	if difficultyName == 'parappa' then
	    noteTweenX('note4', 8, 428, 0.00001, "linear")
	    noteTweenX('note5', 9, 530, 0.00001, "linear")
	    noteTweenX('note6', 10, 632, 0.00001, "linear")
	    noteTweenX('note7', 11, 734, 0.00001, "linear")
	    noteTweenX('note0', 0, defaultPlayerStrumX0 + 100, 0.00001, "linear")
	    noteTweenX('note1', 1, defaultPlayerStrumX1 + 90, 0.00001, "linear")
	    noteTweenX('note2', 2, defaultPlayerStrumX2 + 80, 0.00001, "linear")
	    noteTweenX('note3', 3, defaultPlayerStrumX3 + 70, 0.00001, "linear")
	end
end
